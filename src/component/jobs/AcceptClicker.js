...
const AcceptClicker = inject("cfgState", "navigationState", "cfgPanelState",
    ...
    observer(({
        ...
        const run = async () => {
            let cfg = cfgState.systemCfg.cfg.linkedInLike.accepter;
            let root = cfgState.systemCfg.cfg.linkedInLike.root;
            logging = cfg.log;
            navigationState.syncCurrentPageByWindowLocation("AcceptClicker.run()")
