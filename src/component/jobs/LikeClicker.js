...
import {
    ...
    isOnIgnoreList, retrieveElementForLikeByRule,
    witMessageCallBack, sleep
} from "../../utils/CUtils";

const LikeClicker = inject("cfgState", "navigationState", "cfgPanelState",
    ...
    observer(({
        ...
        const callWitAi = (textToWit, element, cfg, callback) => {
            logging && console.log(logPrefix + " callWitAi textToWit: " + textToWit);
