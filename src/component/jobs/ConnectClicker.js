...
const ConnectClicker = inject("cfgState", "navigationState", "cfgPanelState",
    ...
    observer(({cfgState, navigationState, cfgPanelState,
        ...
        const run = async () => {
            let cfg = cfgState.systemCfg.cfg.linkedInLike.connector;
            let root = cfgState.systemCfg.cfg.linkedInLike.root;
            logging = cfg.log;
            navigationState.syncCurrentPageByWindowLocation("ConnectClicker.run()")
...
export default ConnectClicker;

//134
//Your invitation to Mritunjay was not sent because you have reached the weekly limit for connection invitations. Please try again next week