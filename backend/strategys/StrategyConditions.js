function shouldBuy({currentAnalysis, previousAnalysis, currentCandle}) {
...
function shouldSell({price, position, currentAnalysis, currentCandle}) {
    const {rsi14, trend, pattern, aroonTrend} = currentAnalysis;
...
module.exports = {strategyCondition, shouldBuy, shouldSell};